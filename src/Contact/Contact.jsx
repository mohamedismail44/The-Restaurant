      ...
      <form>
        <div className="p-2 w-full">
          <div className="relative">
            <label for="name" className="leading-7 py-4 text-lg text-gray-900">
              Name
            </label>
            <input
              type="text"
        ...
        <div className="p-2 w-full">
          <div className="relative">
            <label for="email" className="leading-7 py-4 text-lg text-gray-900">
              Email
            </label>
            <input
              type="email"
        ...
        <div className="p-2 w-full">
          <div className="relative">
            <label for="message" className="leading-7 py-4 text-lg text-gray-900">
              Message
            </label>
            <textarea
              id="message"
